...
void sethandtype(hand *hand)
{
    ...
    for (int i = 0; i < HAND_SIZE; i++)
    {
        if (cardcount[i] == 5 || (cardcount[i] + jokercount == 5 && hand->cards[i] != 'J'))
        {
    ...
    for (int i = 0; i < HAND_SIZE; i++)
    {
        if  (cardcount[i] == 4 || (cardcount[i] + jokercount == 4 && hand->cards[i] != 'J'))
        {
    ...
    for (int i = 0; i < HAND_SIZE; i++)
    {
        if (cardcount[i] == 3 || (cardcount[i] + jokercount == 3 && hand->cards[i] != 'J'))
        {
